...
export default ({
	...
	inBounce      : function(x,t,b,c,d){ return c - this.outBounce( x, d-t, 0, c, d) + b; },
	...
	inOutBounce   : function(x,t,b,c,d){ if(t < d/2){ return this.inBounce(x, t*2, 0, c, d) * 0.5 + b;}else{ return this.outBounce(x, t*2-d, 0, c, d) * 0.5 + c*0.5 + b; }}  
})
